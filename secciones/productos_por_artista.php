...
$discos = $miObjetoDisco -> coleccion_por_artista($artistaSeleccionado);
$miTituloSeccionBonito = ucfirst(str_replace("_", " ", $artistaSeleccionado));
?>

<h2 class="text-center my-5"><?=$titulo; ?><?=$miTituloSeccionBonito; ?></h2>
	...
	<div class="row mb-3">
		...
		<a href="index.php?sec=detalle&id=<?= $producto->id; ?>">
		 ...
		 <div class ="col-md">
			...
			<p><strong>Artista: <?= $producto->artista_formateado() ?></strong></p>
